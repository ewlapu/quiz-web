...
export default function Attempts() {
  ...
  const columns = [
    ...
    },
    {
      key: 'subject',
      label: 'Môn học',
      render: (attempt) => attempt.examId?.subjectId?.name || 'N/A',
    },
    {
      key: 'score',
      label: 'Điểm số',
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Xem và quản lý tất cả bài làm của người dùng"
        icon={CheckSquare}
      />
            ...
            <div className="border-t pt-4">
              ...
              <div className="space-y-3">
                {selectedAttempt.answers?.map((answer, idx) => {
                  const question = selectedAttempt.answers?.find(a => a.questionId?._id === answer.questionId)?.questionId || answer.questionId;
